...
resource "aws_instance" "practice" {
  ...
  security_groups = [data.aws_security_group.sg.name,data.aws_security_group.webappSG.name]
  tags = {
    Name = "practice"
  }
...
data "aws_security_group" "webappSG" {
  filter {
    name = "description"
    values = ["allows traffic from web server"]
  }
}
